...
const routes: Routes = [
  ...
  {path: 'showAlbum/:id', component:AlbumShowComponent},
  {path: 'showAlbumDoc', component: AlbumShowDocComponent},
  {path: 'createAlbum/:id', component:AlbumCreateComponent},
  {path: 'createAlbumDoc', component: AlbumCreateDocComponent},
  {path: 'showSong/:id', component:SongShowComponent},
  {path: 'showSongDoc', component:SongShowDocComponent},
  {path: 'createSong/:id', component:SongCreateComponent},
  {path: 'createSongDoc', component:SongCreateDocComponent},
  {path: 'showAllSong/:id', component:SongShowAllComponent},
  ...
  {path: 'selectFavorites/:id', component:SelectFavoriteComponent},
  {path: 'selectFavoritesDoc', component:FavoriteSelectDocComponent},
  {path: 'showFavorites/:id', component:ShowFavoriteComponent},
  ...
  {path: 'showGenres/:id', component: ShowGenreComponent},
